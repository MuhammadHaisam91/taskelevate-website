...
function FloatingPanelCard({
  ...
  // ✅ Hooks are now used inside a normal component (NOT inside map)
  const parallaxX = useTransform(
    mouseXSpring,
    [-20, 20],
    [-panel.position.z / 10, panel.position.z / 10]
  );
...
const TaskelevateHero: React.FC = () => {
  ...
  const panels: FloatingPanel[] = [
    ...
    },
    {
      ...
      delay: 0.6,
      image:
        'linear-gradient(135deg, rgba(147, 197, 253, 0.1) 0%, rgba(191, 219, 254, 0.1) 100%)',
    },
    {
      id: 4,
      ...
      delay: 0.3,
      image:
        'linear-gradient(135deg, rgba(99, 102, 241, 0.13) 0%, rgba(139, 92, 246, 0.13) 100%)',
    },
  ];
      ...
      <div ref={containerRef} className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid min-h-screen grid-cols-1 items-center gap-12 py-20 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            >
              <div className="bg-gradient-to-r from-purple-600 via-violet-600 to-blue-600 bg-clip-text text-3xl font-bold text-transparent">
                Taskelevate
              </div>
            </motion.div>
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                <motion.span
                  className="absolute inset-0 bg-gradient-to-r from-purple-400 to-blue-400 opacity-30 blur-xl"
            ...
            >
              Taskelevate builds high-performance Shopify growth systems combining
              conversion design, paid acquisition, and retention — engineered for
              predictable revenue.
            </motion.p>
